                        ...
                        return (
                            ...
                            <div key={car._id} className='shadow-md rounded-md cursor-pointer'>
                                ...
                                <div className='relative'>
                                    <img src={car.image} alt={car.brand} onClick={()=>navigate(`/DetailedCar/${car._id}`)} className={`w-full h-[192px] object-cover rounded-md transform transition-all duration-300 ease-out hover:-translate-y-1`} />
